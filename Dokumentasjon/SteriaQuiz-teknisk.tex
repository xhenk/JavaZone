...
\usepackage{listings}
\lstset{basicstyle=\ttfamily\footnotesize, frame=single, numbers=left, xleftmargin=2.5em, framexleftmargin=2em}
\begin{document}
	\maketitle
	\section{SteriaQuiz}
		...
		Registrering av svar foregår i PHP\footnote{Det \textit{døende} serversidespråket} mot en XML-fil. 
