	...
	<body onLoad="loadComments();">
		<table>
			<tr>
				...
				<p>
					En <a href="./Sencha/app.html">quiz</a> til JavaZone! (som bare støtter Chrome eller mobilnettleser!)
					<br/>
					Ta quizen og se hvor du ender opp på <a href="scoreboard.xml">resultatlisten</a>! Hurra!
					<br/>
				</p>
				<p>
					En robot som kaster godteri (denne kan besøkes i 22. etg. i hjørnet mot Bygdøy)
